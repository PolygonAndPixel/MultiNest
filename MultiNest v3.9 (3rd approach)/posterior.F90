...
subroutine pos_samp(Ztol,nIter,root,nLpt,ndim,nCdim,nPar,outfile,globZ,globinfo,ic_n,ic_Z,ic_info,ic_reme, &
...
!     write(*,*) 'nPtPerNode ', nPtPerNode(i1)
...
!         if(nPtPerNode(i1) < 2 .or. nPtPerNode(i1) > nIter-1) then
!             write(*,*) '~~~'
!             write(*,*) 'i ', i
!             write(*,*) 'i1 ', i1
!             write(*,*) 'nPtPerNode(i1) ', nPtPerNode(i1)
!             write(*,*) 'ic_n ', ic_n
!             write(*,*) 'nIter ', nIter
!         endif
        ...
        wt(i1,nPtPerNode(i1))=exp(evdatp(i1,nPtPerNode(i1),nPar+1)+evdatp(i1,nPtPerNode(i1),nPar+2)-gzloc)
!         if(nPtPerNode(i1) < 1 .or. nPtPerNode(i1) > nIter) then
!             write(*,*) '###'
!             write(*,*) 'i ', i
!             write(*,*) 'i1 ', i1
!             write(*,*) 'nPtPerNode(i1) ', nPtPerNode(i1)
...
!             write(*,*) 'nIter ', nIter
!         endif
        if(wt(i1,nPtPerNode(i1))>0.d0) then
            lognpost=lognpost-wt(i1,nPtPerNode(i1))*log(wt(i1,nPtPerNode(i1)))
        endif
    enddo
